  ...
  useEffect(() => {
    ...
    try {
      ...
      Promise.resolve(
        ...
        .catch((error) => {
          console.warn(`[Nitro Ad] Failed to create small rail ad:`, error);
        });
      ...
      Promise.resolve(
        ...
        .catch((error) => {
          console.warn(`[Nitro Ad] Failed to create wide rail ad:`, error);
        });
    } catch (error) {
      console.warn(`[Nitro Ad] Error initializing rail ads:`, error);
    }
