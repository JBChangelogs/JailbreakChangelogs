...
const AddServerModal: React.FC<AddServerModalProps> = ({
  ...
  const handleSubmit = async () => {
    ...
    if (editingServer) {
      ...
      const originalExpiresNormalized =
      ...
      const hasChanges =
        ...
        normalizedExpires !== originalExpiresNormalized;
          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                className="border-border-card bg-tertiary-bg text-primary-text placeholder-secondary-text hover:border-border-focus focus:border-button-info w-full rounded-md border px-3 py-2 focus:outline-none"
            ...
            <div>
                ...
                <div className="w-full sm:flex-1">
                  <label
                    ...
                    className={`mb-2 block text-sm font-medium ${
                      neverExpires ? "text-secondary-text" : "text-primary-text"
                    }`}
                  >
                    Date
                  </label>
                  ...
                  >
                    ...
                    <PopoverContent
                      align="start"
                      className="border-border-card bg-secondary-bg z-[10001] w-auto p-0"
                    >
                      <Calendar
                        mode="single"
              ...
              {neverExpires && (
                <p className="text-secondary-text mt-1 text-sm">
                  Expiry fields are disabled because this server never expires.
                </p>
              )}
            </div>
