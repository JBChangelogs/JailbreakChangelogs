  ...
  return (
    <div className={`relative ${className}`}>
        ...
        <div className="border-tertiary-bg bg-secondary-bg absolute z-10 mt-1 w-full rounded-lg border p-2 shadow-lg">
          <div className="flex flex-col gap-1">
            ...
            >
              ...
              <span className="text-secondary-text group-hover:text-link transition-colors">
                Show videos
              </span>
            </button>
            <button
      ...
      {searchResults.length > 0 ? (
        ...
        searchQuery && (
          <div className="border-tertiary-bg bg-secondary-bg text-secondary-text absolute z-10 mt-1 w-full rounded-lg border p-4 text-center">
            No results found
          </div>
        )
      )}
