...
export default function ItemSuggestionsTab({
  ...
  return (
    <div className="space-y-4">
      {/* Header */}
      <div className="border-border-card bg-secondary-bg flex items-center justify-between rounded-lg border p-3">
            ...
            >
              ...
              <div className="space-y-3 p-4">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="border-border-card bg-tertiary-bg/30 rounded-lg border p-3">
