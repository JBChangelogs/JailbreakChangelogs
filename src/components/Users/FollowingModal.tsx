                        ...
                        <div className="flex items-center space-x-1.5 sm:space-x-3">
                          ...
                          <div className="min-w-0 flex-1">
                            <div className="flex items-center">
                              <h3 className="text-xs sm:text-base font-semibold text-muted truncate max-w-[120px] sm:max-w-none">
                                {isPrivateProfile ? (
                                  "Hidden User"
                                ) : (
                            ...
                            <p className="text-[10px] sm:text-sm text-[#FFFFFF] truncate max-w-[120px] sm:max-w-none">
                              {isPrivateProfile ? (
                                "Private Profile"
                              ) : (
                                `@${user.username}`
