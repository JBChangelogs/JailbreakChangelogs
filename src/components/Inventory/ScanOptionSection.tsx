          ...
          >
            {!isAuthenticated ? (
              ...
              !ENABLE_WS_SCAN ? (
                <button
                  disabled
                  className="bg-button-info-disabled text-form-button-text border-button-info-disabled inline-flex items-center gap-1.5 rounded-md px-3 py-1.5 text-xs font-medium cursor-not-allowed"
                >
                  <svg
                    className="h-4 w-4"
                    fill="none"
