    ...
    <div className="space-y-6">
              ...
              {Object.entries(percentages)
                ...
                .map(([category, percentage]) => {
                  ...
                  return (
                    <div
                      key={category}
                      className="border-border-card bg-secondary-bg flex items-center justify-between gap-2 rounded border p-2 text-sm"
                    >
      ...
      {duplicatesCount !== undefined &&
        ...
        Object.keys(duplicatesPercentages).length > 0 && (
          <div className="border-border-card border-t pt-6">
            <h4 className="text-primary-text mb-3 text-sm font-semibold">
