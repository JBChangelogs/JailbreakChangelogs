      ...
      return (
        <div className="bg-secondary-bg border-border-primary rounded-lg border p-6 text-center">
          ...
          <button
            ...
            className="border-border-primary hover:border-border-focus bg-button-info text-form-button-text hover:bg-button-info-hover rounded-lg border px-4 py-2 focus:outline-none"
          >
            Try Again
          </button>
        </div>
