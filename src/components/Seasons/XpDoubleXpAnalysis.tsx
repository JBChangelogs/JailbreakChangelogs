    ...
    <div className="rounded-lg border border-[#2E3944] bg-[#212A31] p-4">
      ...
      <div className="space-y-3">
        <div className="flex items-center">
          <span
            className={`mr-2 text-lg ${doubleXpResults.noPass.achievable ? "text-green-400" : "text-red-400"}`}
          >
        ...
        <div className="flex items-center">
          <span
            className={`mr-2 text-lg ${doubleXpResults.withPass.achievable ? "text-green-400" : "text-red-400"}`}
          >
