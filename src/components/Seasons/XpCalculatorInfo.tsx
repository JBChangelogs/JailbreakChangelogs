  ...
  return (
    <div className="mb-6 rounded-lg border border-[#2E3944] bg-[#212A31] p-4">
      ...
      <div className="text-muted space-y-2 text-sm">
        ...
        <p>
          • <strong>Season Pass:</strong> Whether you have the premium season
          pass
        </p>
        <p>
          • <strong>Target Level:</strong> The level you want to reach (usually
          level 10)
        </p>
        <p>
      ...
      <div className="text-muted mt-3 text-xs">
        <p>
          ...
          contract rewards, and season timing to give you the most accurate
          estimate.
        </p>
      </div>
    </div>
