...
export default function TradeUserProfile({ user }: TradeUserProfileProps) {
  return (
    <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center">
      <div className="w-full rounded-lg border border-[#37424D] bg-[#2E3944] p-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                >
                  <Link
                    href={`/users/${user.id}`}
                    className="font-medium text-blue-300 transition-colors hover:text-blue-400"
                  >
                ...
                <div className="text-sm text-[#FFFFFF]">@{user.username}</div>
              </div>
            </div>
          </div>

          {/* Divider */}
          <div className="hidden h-12 w-px bg-[#5865F2]/60 sm:block" />
