...
export const useSupporterModal = () => {
  ...
  const checkCommentLength = useCallback((content: string, userTier: number) => {
  ...
  const checkAvatarAccess = useCallback((userTier: number) => {
    if (userTier < 1) {
      openModal({
  ...
  const checkBannerAccess = useCallback((userTier: number) => {
    if (userTier < 2) {
      openModal({
  ...
  const checkAnimatedAvatarAccess = useCallback((userTier: number) => {
    if (userTier < 3) {
      openModal({
  ...
  const checkAnimatedBannerAccess = useCallback((userTier: number) => {
    if (userTier < 3) {
      openModal({
  ...
  const checkTradeAdDuration = useCallback((selectedDuration: number, userTier: number) => {
