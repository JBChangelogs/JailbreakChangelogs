          ...
          <div className="mb-6 flex flex-col lg:flex-row lg:items-start gap-6">
            ...
            {premiumStatusLoaded && currentUserPremiumType === 0 && (
              <div className="flex-shrink-0 w-full max-w-[700px] mt-4 lg:mt-0">
                <div className="w-full bg-[#1a2127] rounded-lg overflow-hidden border border-[#2E3944] shadow transition-all duration-300 relative flex items-center justify-center">
