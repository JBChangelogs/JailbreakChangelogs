            ...
            <div className="w-full lg:w-1/3">
              <div className="relative">
                ...
                <input
                  ...
                  className="border-border-card bg-secondary-bg text-primary-text placeholder-secondary-text hover:border-border-focus focus:border-button-info h-14 w-full rounded-lg border px-4 py-2 pr-10 pl-10 text-sm transition-all focus:outline-none"
                />
                {searchQuery && (
                  <button
