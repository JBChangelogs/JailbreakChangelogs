...
import { fetchUserByIdForOG } from "@/utils/api/api";
...
export async function GET(request: Request) {
  ...
  if (
    user.settings_v2?.custom_avatar === true &&
    user.premiumtype &&
    user.premiumtype >= 2 &&
    user.custom_avatar &&
    ...
    avatarUrl = `https://cdn.discordapp.com/avatars/${user.id}/${user.avatar}?size=4096`;
  } else {
