                    ...
                    <div className="container mx-auto px-4">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex gap-4">
                            ...
                            >
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="rounded-full bg-[#0085FF] p-3 text-white transition-colors hover:bg-[#006acc]"
                                aria-label="Bluesky"
                              >
                                <svg
                                  className="h-6 w-6"
                          ...
                          <div className="pt-4">
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="text-muted mt-2 flex items-center gap-2 hover:text-[#FFFFFF]"
                            >
                              <svg
                                className="h-5 w-5"
                                fill="currentColor"
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex flex-col gap-2 pt-4">
                              ...
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-muted flex items-center justify-center gap-2 rounded-lg border border-[#37424D] bg-[#37424D] px-4 py-2 transition-colors hover:bg-[#2E3944]"
                              >
                                <svg
                                  className="h-5 w-5"
                                  fill="currentColor"
                      ...
                      <div className="mt-12 border-t border-[#2E3944] pt-8">
                        <div className="flex flex-col items-start justify-between gap-4 lg:flex-row lg:items-center">
                          <p className="text-muted">
                            &copy; {new Date().getFullYear()} Jailbreak
                            Changelogs. All rights reserved.
                          </p>
                ...
                <div className="container mx-auto px-4">
                  <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="pt-4">
                        <p className="text-muted text-sm">Sub Communities:</p>
                        <a
                          href="https://www.reddit.com/r/RobloxJailbreak"
                          target="_blank"
                          rel="noopener noreferrer"
