      ...
      <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
        {sortedPages.length === 0 ? (
          ...
          <div className="relative">
            ...
            <div className="scrollbar-track-secondary-bg scrollbar-thumb-button-info/20 hover:scrollbar-thumb-button-info/40 max-h-250 scrollbar-thin overflow-y-auto pr-4 transition-colors">
              <div className="relative">
                {/* Timeline line */}
                <div
