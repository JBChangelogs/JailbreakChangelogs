  ...
  useEffect(() => {
    const fetchItem = async () => {
      try {
        ...
        const response = await fetch(`${PROD_API_URL}/items/get?name=${encodeURIComponent(itemName)}&type=${encodeURIComponent(itemType)}`);
            ...
            if (Array.isArray(favoritesData)) {
              const isItemFavorited = favoritesData.some(fav => {
                ...
                if (favoriteId.includes('-')) {
                  ...
                  return Number(parentId) === data.id;
                }
                return Number(favoriteId) === data.id;
              });
        ...
        const countResponse = await fetch(`${PROD_API_URL}/item/favorites?id=${data.id}&nocache=true`);
        if (countResponse.ok) {
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="relative">
                <div className="relative aspect-video w-full overflow-hidden rounded-lg bg-[#212A31]">
                  <Skeleton variant="rectangular" height="100%" sx={{ bgcolor: '#37424D' }} />
                </div>
                <div className="rounded-lg bg-[#212A31] p-4 mt-4">
                  <Skeleton variant="text" width="60%" height={24} sx={{ bgcolor: '#37424D' }} />
              ...
              <div className="space-y-6">
                <div>
                  <Skeleton variant="text" width="70%" height={40} sx={{ bgcolor: '#37424D' }} />
                  <Skeleton variant="text" width="40%" height={24} sx={{ bgcolor: '#37424D' }} />
                ...
                <div className="space-y-4">
                  <div className="rounded-lg bg-[#212A31] p-4">
                    ...
                    <div className="space-y-2 mt-2">
                      ...
                      <Skeleton variant="text" width="90%" height={20} sx={{ bgcolor: '#37424D' }} />
                      <Skeleton variant="text" width="80%" height={20} sx={{ bgcolor: '#37424D' }} />
                    </div>
                  </div>
                  ...
                  <div className="rounded-lg bg-[#212A31] p-4">
                    <div className="grid grid-cols-2 gap-4">
                      <Skeleton variant="rounded" height={80} sx={{ bgcolor: '#37424D' }} />
                      <Skeleton variant="rounded" height={80} sx={{ bgcolor: '#37424D' }} />
                    </div>
                  </div>
                  ...
                  <div className="rounded-lg bg-[#212A31] p-4">
                    <Skeleton variant="text" width="40%" height={24} sx={{ bgcolor: '#37424D' }} />
                    <div className="flex flex-wrap gap-2 mt-2">
                      <Skeleton variant="rounded" width={100} height={32} sx={{ bgcolor: '#37424D' }} />
                      <Skeleton variant="rounded" width={100} height={32} sx={{ bgcolor: '#37424D' }} />
                      <Skeleton variant="rounded" width={100} height={32} sx={{ bgcolor: '#37424D' }} />
                    </div>
                  </div>
      ...
      <main className="min-h-screen bg-[#2E3944]">
        <div className="container mx-auto px-4 mb-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-3xl font-bold text-muted">{currentItem.name}</h1>
