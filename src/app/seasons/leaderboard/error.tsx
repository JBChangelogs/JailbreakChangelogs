...
export default function Error({
  ...
  useEffect(() => {
    log.error("Seasons leaderboard error", error);
  }, [error]);
        ...
        <div className="min-h-[calc(100vh-8rem)] lg:flex lg:items-center lg:gap-12">
          <div className="w-full lg:w-1/2">
            <p className="text-secondary-text text-sm font-medium">
              Seasons leaderboard error
            </p>
            <h1 className="text-primary-text mt-3 text-2xl font-semibold md:text-3xl">
              Failed to load seasons leaderboard
            </h1>
            <p className="text-secondary-text mt-4">
              Something went wrong while loading the seasons leaderboard.
            </p>
