  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mt-8">
        ...
        <div className="border-border-card bg-secondary-bg rounded-lg border p-4 shadow-sm">
          <div className="max-h-192 space-y-3 overflow-y-auto pr-2">
            {Array.from({ length: 15 }).map((_, index) => (
              <div
                key={index}
                className="border-border-card flex items-center justify-between rounded-lg border p-3"
              >
