      ...
      <div className="container mx-auto mb-8 px-4 sm:px-6">
        ...
        <div className="mb-8 grid grid-cols-1 gap-4">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div className="border-border-card bg-button-secondary h-12 animate-pulse rounded-lg border"></div>
            <div className="border-border-card bg-button-secondary h-12 animate-pulse rounded-lg border"></div>
            <div className="border-border-card bg-button-secondary h-12 animate-pulse rounded-lg border"></div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-8 xl:grid-cols-12">
          ...
          <div className="sm:col-span-12 xl:col-span-8">
            <div className="border-border-card bg-button-secondary mb-4 h-8 w-1/2 animate-pulse rounded border"></div>
            <div className="border-border-card bg-button-secondary mb-4 h-4 w-full animate-pulse rounded border"></div>

            <div className="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="border-border-card bg-secondary-bg hover:border-border-focus rounded-lg border p-4"
                >
            ...
            <div className="border-border-card bg-button-secondary mb-4 h-6 w-1/4 animate-pulse rounded border"></div>
              ...
              <div className="space-y-4">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="flex items-start gap-2">
                    <div className="border-border-card bg-button-secondary h-10 w-10 animate-pulse rounded-full border"></div>
