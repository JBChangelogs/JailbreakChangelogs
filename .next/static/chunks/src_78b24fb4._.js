...
const fetchUsers = async ()=>{
    const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROD_API_URL"]}/users/list?nocache=true`, {
        cache: 'no-store',
        next: {
            revalidate: 0
        }
...
async function fetchUserById(id) {
    try {
        ...
        const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TEST_API_URL"]}/users/get?id=${id}&nocache=true`);
        const data = await response.json();
        if (!response.ok) {
...
async function fetchItems() {
    try {
        const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROD_API_URL"]}/items/list`);
...
async function fetchLastUpdated(items) {
    try {
        ...
        const formattedDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$timestamp$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatFullDate"])(mostRecentItem.last_updated);
...
async function fetchChangelogList() {
    const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROD_API_URL"]}/changelogs/list`);
    if (!response.ok) throw new Error('Failed to fetch changelog list');
    return response.json();
}
async function fetchChangelog(id) {
    const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROD_API_URL"]}/changelogs/get/?id=${id}`);
...
"[project]/src/app/contributors/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const LoadingState = ({ count = 4 })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$3$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: Array.from({
            length: count
        }).map((_, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$3$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ContributorCardSkeleton, {}, index, false, {
                fileName: "[project]/src/app/contributors/page.tsx",
                lineNumber: 27,
                columnNumber: 7
            }, this))
...
function ContributorsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$3$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ContributorsPage.useEffect": ()=>{
            const loadUsers = {
                "ContributorsPage.useEffect.loadUsers": async ()=>{
                    setIsLoading(true);
                    try {
                        const ownerIds = [
                            '659865209741246514',
                        ...
                        const ownerUsers = await Promise.all(ownerIds.map({
                            "ContributorsPage.useEffect.loadUsers": (id)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchUserById"])(id)
                        }["ContributorsPage.useEffect.loadUsers"]));
                        ...
                        const managerUsers = await Promise.all(managerIds.map({
                            "ContributorsPage.useEffect.loadUsers": (id)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchUserById"])(id)
                        }["ContributorsPage.useEffect.loadUsers"]));
                        // Sort manager users alphabetically
                        managerUsers.sort({
                            "ContributorsPage.useEffect.loadUsers": (a, b)=>{
                        ...
                        const valueTeamUsers = await Promise.all(valueTeamIds.map({
                            "ContributorsPage.useEffect.loadUsers": (id)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchUserById"])(id)
                        }["ContributorsPage.useEffect.loadUsers"]));
                        ...
                        const contributorUsers = await Promise.all(contributorIds.map({
                            "ContributorsPage.useEffect.loadUsers": (id)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchUserById"])(id)
                        }["ContributorsPage.useEffect.loadUsers"]));
                        ...
                        const backgroundPictureUsers = await Promise.all(backgroundPictureIds.map({
                            "ContributorsPage.useEffect.loadUsers": (id)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchUserById"])(id)
                        }["ContributorsPage.useEffect.loadUsers"]));
                        // Sort background picture users alphabetically
                        backgroundPictureUsers.sort({
                            "ContributorsPage.useEffect.loadUsers": (a, b)=>{
                                const nameA = (a.global_name && a.global_name !== "None" ? a.global_name : a.username).toLowerCase();
                                const nameB = (b.global_name && b.global_name !== "None" ? b.global_name : b.username).toLowerCase();
                                return nameA.localeCompare(nameB);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$3$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$3$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(LoadingState, {
                count: 2
            }, void 0, false, {
                fileName: "[project]/src/app/contributors/page.tsx",
                lineNumber: 127,
...
_s(ContributorsPage, "iKpSC5TTyjWB7+gWJ1wB5ZLuPgs=");
_c2 = ContributorsPage;
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "ContributorCardSkeleton");
__turbopack_context__.k.register(_c1, "LoadingState");
__turbopack_context__.k.register(_c2, "ContributorsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_78b24fb4._.js.map